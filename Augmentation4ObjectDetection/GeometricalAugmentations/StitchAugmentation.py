...
class StitchAugmentation(object):
    ...
    def process_augmentation(self, list4imgs, list4rois, list4lbls):
        ...
        for ii, index in enumerate(range(len(list4imgs))):
            ...
            aug_rois = np.vstack((aug_rois, rsz_rois))
            aug_lbls = np.vstack((aug_lbls, orig_lbl))
